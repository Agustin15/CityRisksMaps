...
Aplicacion web que muestra la tendencia de los tipos de delitos por barrio y su crecimiento
con representacion grafica en un mapa, tambien incluye visualizacion de lugares de montevideo.
Los datos de las cantidad de denuncias fueron obtenidos de [Datos abiertos del Ministerio del interior.](https://catalogodatos.gub.uy/dataset/ministerio-del-interior-delitos_denunciados_en_el_uruguay)
...
### Variables de entorno
    ...
    VITE_MAPS_API_KEY_BACKOFFICE=<GOOGLE MAPS API KEY BACKOFFICE>
    ...
    VITE_MAP_ID_BACKOFFICE=<ANOTHER MAP ID OF GOOGLE MAPS API FOR BACKOFFICE MAP>
