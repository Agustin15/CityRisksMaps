...
select * from Crimes where category ='Homicidio' or category ='Hurto' or category ='Rapi�a';
END
GO
...
CREATE OR ALTER PROCEDURE AddZone @description VARCHAR(250),@coordinates NVARCHAR(MAX) AS
BEGIN 
...
INSERT INTO Zones(description,coordinates,lastModified) VALUES(@description,@coordinates,null);
IF(@@ERROR<>0)
RETURN -3
...
CREATE OR ALTER PROCEDURE UpdateZone @idZone INT,@description VARCHAR(250),@coordinates NVARCHAR(MAX) AS
BEGIN 
...
Update Zones set description=@description,coordinates=@coordinates where idZone=@idZone
...
CREATE OR ALTER PROCEDURE AddZoneNeighborhood @idZone INT,@neighborhood VARCHAR(30) AS
BEGIN 

IF NOT EXISTS(select * from Neighborhoods where name=@neighborhood)
RETURN -1

INSERT INTO Zones_Neighborhoods VALUES (@idZone,@neighborhood);
...
EXEC AddNeighborhood 'Colón Sureste - Abayubí',1;
...
EXEC AddPopulation 'Colón Sureste - Abayubí',14354,2023;
...
EXEC AddNeighborhoodCrime 'Colón Sureste - Abayubí','Homicidio',3,2022;
...
EXEC AddNeighborhoodCrime 'Colón Sureste - Abayubí','Hurto',null,2022;
...
EXEC AddNeighborhoodCrime 'Colón Sureste - Abayubí','Rapiña',null,2022;
...
EXEC AddNeighborhoodCrime 'Colón Sureste - Abayubí','Homicidio',5,2023;
...
EXEC AddNeighborhoodCrime 'Colón Sureste - Abayubí','Hurto',1299,2023;
...
EXEC AddNeighborhoodCrime 'Colón Sureste - Abayubí','Rapiña',257,2023;
...
EXEC AddNeighborhoodCrime 'Baños de Carrasco','Homicidio',7,2024;
...
EXEC AddNeighborhoodCrime 'Baños de Carrasco','Hurto',NULL,2024;
...
EXEC AddNeighborhoodCrime 'Baños de Carrasco','Rapiña',NULL,2024;
